...
function unpop()
	tweenFadeOut(white,0,0.50)
end

function pop()
	tweenFadeIn(white,1,0.50,'unpop')
end
...
function resetTween()
 ...
 function update (elapsed) 
  ...
  if curStep == 1016 or curStep == 1656 then
		pop()
	end		
...
--    end	
    ...
    if curStep >= 254 and beat % 0.2 == 0 and curStep < 511 then
        setHudZoom(0.8)
        setCamZoom(0.8)		
    ...
    if curStep >= 1406 and beat % 0.2 == 0 and curStep < 1536 then
        setHudZoom(0.8)
        setCamZoom(0.8)		
        tweenHudZoom(0.8,0.1)	
        tweenCamZoom(0.8,0.1)			
...
function playerOneSing(noteData, pos)
	...
	if curStep >= 784 and curStep < 816 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
    ...
    if curStep >= 816 and curStep < 834 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
	...
	if curStep >= 848 and curStep < 880 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
	 ...
	 if curStep >= 880 and curStep < 898 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
	...
	if curStep >= 912 and curStep < 944 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
	 ...
	 if curStep >= 944 and curStep < 959 then
        if data == 0 then
           	cameraAngle = 10
			camHudAngle = 10
       elseif data == 1 then
